...
public sealed class CounterStrikeSource : IDisposable
{
    ...
    /// <summary>Initializes a new CSS server client with the specified connection details.</summary>
    ...
    /// <summary>Connects to the CSS RCON server and authenticates.</summary>
