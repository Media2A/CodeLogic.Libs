...
/// <summary>
/// Translates column-level C# expressions into PostgreSQL SQL fragments. This is the
/// read-side counterpart to <see cref="PostgreSqlExpressionVisitor"/> (which handles WHERE
...
internal static class SqlExpressionTranslator
{
    ...
    private sealed class Visitor
    {
        ...
        private (string Sql, Type ClrType) VisitMember(MemberExpression m)
        {
            ...
            // expressions; WHERE-side parameter binding is handled by PostgreSqlExpressionVisitor.
        ...
        private (string Sql, Type ClrType) VisitSqlFn(MethodCallExpression mc)
        {
            ...
            switch (mc.Method.Name)
            {
                ...
                // PostgreSQL has no IFNULL; two-argument COALESCE is the equivalent.
