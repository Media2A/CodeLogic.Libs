...
public sealed class TableAttribute : Attribute
{
    ...
    /// <summary>Schema name. Defaults to <c>dbo</c>.</summary>
...
public sealed class ColumnAttribute : Attribute
{
    ...
    /// <summary>SQL Server data type for the column.</summary>
    ...
    /// <summary>Whether this column uses <c>IDENTITY(1,1)</c>.</summary>
    ...
    /// <summary>Column collation override. Optional.</summary>
...
/// <summary>
/// Marks an entity for <b>soft deletes</b>. <see cref="CL.MSSQL.Services.Repository{T}.DeleteAsync(object, System.Threading.CancellationToken)"/>
/// sets the named timestamp column to the current UTC time instead of issuing a physical DELETE, and
/// reads through <c>mssql.Query&lt;T&gt;()</c> and the repository getters automatically exclude
