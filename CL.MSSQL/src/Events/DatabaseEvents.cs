...
namespace CL.MSSQL.Events;

/// <summary>Published when a SQL Server connection is successfully opened.</summary>
...
/// <summary>Published when a SQL Server connection is closed.</summary>
