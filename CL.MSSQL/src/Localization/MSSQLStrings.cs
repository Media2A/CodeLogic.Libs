...
namespace CL.MSSQL.Localization;

/// <summary>
/// Localized strings for the CL.MSSQL library.
/// Serialized to / from <c>mssql.{culture}.json</c> in the library's localization directory.
/// </summary>
[LocalizationSection("mssql")]
public class MSSQLStrings : LocalizationModelBase
{
    ...
    public string LibraryInitialized { get; set; } = "SQL Server library initialized";

    [LocalizedString(Description = "Logged when the library starts.")]
    public string LibraryStarted { get; set; } = "SQL Server library started";

    [LocalizedString(Description = "Logged when the library stops.")]
    public string LibraryStopped { get; set; } = "SQL Server library stopped";
